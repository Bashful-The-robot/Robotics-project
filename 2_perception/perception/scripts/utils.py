...
def compile_model(model: torch.nn.Module) -> torch.jit.ScriptModule:
    return torch.jit.script(model)


def save_model(model: torch.nn.Module, path: str, compiled: bool = False) -> None:
    """Save model to disk.
...
def load_model(model: torch.nn.Module, path: str, device: str, compiled: bool = False) -> torch.nn.Module:
